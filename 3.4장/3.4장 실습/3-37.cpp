...
void Player()
{
	...
	/*if (fPlayer_X <= -150.f && fPlayer_X >= -250.f && fPlayer_Z >= 240.f && fPlayer_Z <= 340.f)
	{
		glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
		glColor4f(1.0f, 0.3f, 0.7f, 0.8f);
	}
	else*/

	if (fPlayer_X >= -10.f && fPlayer_X <= 10.f && fPlayer_Z >= 360.f && fPlayer_Z <= 380.f)
	{
		fPlayer_X = -190.f;
		fPlayer_Z = 320.f;
	}
...
GLvoid SetupRC()
{
	...
	pBytes[0] = LoadDIBitmap("3-37 바닥.bmp", &info);
	pBytes[1] = LoadDIBitmap("3-37 꽃.bmp", &info);
	pBytes[2] = LoadDIBitmap("3-37 하늘.bmp", &info);
	pBytes[3] = LoadDIBitmap("3-37 태극기.bmp", &info);
...
void RoundBox()
{
	...
	glBegin(GL_POLYGON);
	glVertex3f(-299.f, 0.0f, 500.f);
	glVertex3f(-299.f, 0.0f, 400.f);
	glVertex3f(-299.f, 200.f, 400.f);
	glVertex3f(-299.f, 200.f, 500.f);
	glEnd();
	...
	glTranslatef(0.f, -49.f, 300.f);
	glutSolidCube(100);
	glTranslatef(0.f, 49.f, 3-00.f);
	glPopMatrix();


	glPushMatrix();
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
	glColor4f(0.0f, 0.0f, 0.5f, fBlend1);
	glTranslatef(-200.f, 50.f, 300.f);
	glutSolidCube(100);
	glTranslatef(200.f, -50.f, -300.f);
	...
	glPushMatrix();
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
	glColor4f(0.0f, 0.5f, 0.0f, fBlend2);
	glTranslatef(200.f, 50.f, 300.f);
	glutSolidCube(100);
	glTranslatef(-200.f, -50.f, -300.f);
	glBlendFunc(GL_ONE, GL_ZERO);
